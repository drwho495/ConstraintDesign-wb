...
from Utils import acceptableFeatureTypes, isType, datumNames
from Commands.SketchUtils import positionSketch
from Entities.Entity import SolvableEntity

class PartMirror(SolvableEntity):
    ...
    def generateShape(self, obj, prevShape):
        ...
        if isType(obj.Support, "PartContainer"):
            ...
            if tip != None:
                ...
                datumShape, elementMap = obj.Support.Proxy.getDatumsCompound(obj.Support, True, obj.Boundary.Name)
            ...
            if planeType == "Face":
                ...
                for element in supportSelection:
                    if len(element) == 2:
                        ...
                        if hasattr(obj, "Type") and obj.Type in datumNames:
                            if len(obj.InList) != 0:
                                feature = obj.InList[0]
                                if hasattr(feature, "Type") and feature.Type in acceptableFeatureTypes:
